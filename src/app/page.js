...
export default function Home() {
  ...
  const PROPERTIES = [
    {
      id: 1,
      image: { src: "/assets/openlands-nri.jpg", alt: "Urban Tower" },
      badges: [
        { label: "Featured", variant: "featured" },
        { label: "Plots", variant: "status" },
      ],
      title: "Urban Tower (NRI Projects Group)",
      address: "Ghatkesar, Edulabad, Hyderabad",
      beds: 0,
      baths: 0,
      sqft: 0,
      price: "₹18,999 / sq yd",
      detailsHref: "/companies/1",
    },
    {
      id: 2,
      image: { src: "/assets/sampangiland.webp", alt: "Sampangi Bio Farmland" },
      badges: [
        { label: "Featured", variant: "featured" },
        { label: "Farmland", variant: "status" },
      ],
      title: "Sampangi Bio Farmland",
      address: "Hyderabad, Telangana",
      beds: 0,
      baths: 0,
      sqft: 0,
      price: "₹5,500 / sq yd",
      detailsHref: "/companies/9",
    },
    {
      id: 3,
