      ...
      <div className="container-custom">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 py-8 border-b border-white/10">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-gold">
            ...
            <div>
              <p className="font-bold text-white text-lg leading-none tracking-wide">PROTY</p>
              <p className="text-xs tracking-widest mt-0.5 text-gold">REAL ESTATE</p>
            </div>
          </div>
