...
export default function ScrollingLogos({
  ...
  return (
    <>
      ...
      {/* ── Dark section ── */}
      <div className="relative bg-[#1B304B] pt-12 md:pt-20">
        ...
        {cta && (
          <>
            ...
            <div className="hidden md:block container-custom absolute left-1/2 -translate-x-1/2 w-full z-20"
              style={{ bottom: "-200px" }}
            >
              <div
              ...
              >
                {/* Swirl */}
                <svg aria-hidden="true" className="absolute pointer-events-none opacity-20"
                  style={{ right: "clamp(160px,22vw,320px)", top: 0, height: "100%" }}
                  width="200" viewBox="0 0 200 300" fill="none">
                  <path d="M100 0 Q175 75 100 150 Q25 225 100 300"  stroke="#B89454" strokeWidth="1.5" fill="none"/>
                  <path d="M130 0 Q205 75 130 150 Q55 225 130 300"  stroke="#B89454" strokeWidth="1"   fill="none"/>
                  <path d="M70  0 Q145 75 70  150 Q-5 225 70  300"  stroke="#B89454" strokeWidth="1"   fill="none"/>
                </svg>

                {/* Text */}
                <div className="relative z-10 max-w-[520px]">
                  <h3 className="text-[var(--color-primary)] font-bold leading-tight mb-3"
                    style={{ fontSize: "clamp(1.4rem,2.4vw,2rem)", fontFamily: "'Playfair Display',serif" }}>
                    {cta.heading}
                  </h3>
                ...
                {cta.image && (
                  <div className="absolute z-20"
                    ...
                    <Image src={cta.image} alt="Real estate agent" fill
            ...
            <div className="md:hidden container-custom mt-8 pb-8">
              <div className="relative rounded-2xl overflow-hidden"
                style={{ background: "#FAF6EF", boxShadow: "0 4px 24px rgba(0,0,0,0.12)" }}>
                ...
                {cta.image && (
                  <div className="relative w-full h-52 sm:h-64 bg-[#f0e8d8]">
                    ...
                    <svg aria-hidden="true" className="absolute inset-0 w-full h-full opacity-10 pointer-events-none"
                      ...
                      <path d="M200 0 Q350 75 200 150 Q50 225 200 300"  stroke="#B89454" strokeWidth="2" fill="none"/>
                      <path d="M260 0 Q410 75 260 150 Q110 225 260 300" stroke="#B89454" strokeWidth="1.5" fill="none"/>
                      <path d="M140 0 Q290 75 140 150 Q-10 225 140 300" stroke="#B89454" strokeWidth="1.5" fill="none"/>
                    </svg>
                  </div>
                )}
                ...
                <div className="px-6 py-6 sm:px-8 sm:py-8">
                  <h3 className="text-[var(--color-primary)] font-bold text-xl sm:text-2xl leading-tight mb-3"
        ...
        {cta && (
          <div className="hidden md:block" style={{ height: "160px" }} />
        )}
      </div>
